...
import dev.calculadora.model.Memoria;

@SuppressWarnings("serial")
public class Teclado extends JPanel implements ActionListener{
	
	private final Color COR_CINZA_ESCURO = new Color(68,68,68);
	private final Color COR_CINZA_CLARO = new Color(96, 100, 97);
	...
	private void adicionarBotao(String texto, Color cor, GridBagConstraints constraints, int posicaoX, int posicaoY) {
		
		constraints.gridx = posicaoX;
		constraints.gridy = posicaoY;
